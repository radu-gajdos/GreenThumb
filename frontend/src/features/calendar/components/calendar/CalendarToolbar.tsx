            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-2">
                    ...
                    >
                        ...
                        <span className="hidden sm:inline">{t('calendarToolbar.view.month')}</span>
                    </Button>
                    <Button
                    ...
                    >
                        ...
                        <span className="hidden sm:inline">{t('calendarToolbar.view.week')}</span>
                    </Button>
                    <Button
                    ...
                    >
                        ...
                        <span className="hidden sm:inline">{t('calendarToolbar.view.list')}</span>
                    </Button>
                </div>
            </div>
        </div>
