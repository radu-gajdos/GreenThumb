...
// Same country/crop lists as before
            ...
            <CardContent className="space-y-6">
                    ...
                    >
                        {loading ? (
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <span>Calculează Predicția</span>
                            </div>
                        )}
                    </Button>
                </div>
                    ...
                    <div className="space-y-4 pt-4 border-t border-gray-200">
                        ...
                        <div className="text-center space-y-2">
                            ...
                            <div className="text-sm text-gray-600">
                                Randament previzionat pentru {prediction.crop} în {prediction.country}, anul {prediction.year}
                            </div>
                        </div>
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <div className="font-medium text-gray-900">
                                                Încredere {ConfidenceLevelLabels[prediction.confidence_level]}
                                            </div>
                                            <div className="text-xs text-gray-600">
                                                Nivel de certitudine AI
                                            </div>
                                        </div>
                                    </div>
                                </CardContent>
                            ...
                            <Card className="bg-blue-50">
                                <CardContent className="p-4">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <div className="font-medium text-gray-900">
                                                {PredictionMethodLabels[prediction.prediction_method] || 'Metodă AI'}
                                            </div>
                                            <div className="text-xs text-gray-600">
                                                Algoritm de predicție
                                            </div>
                                        </div>
                                    </div>
                                </CardContent>
                        ...
                        <div className="bg-gray-50 rounded-lg p-4">
                            <div className="text-sm text-gray-700">
                                <strong>Interpretare:</strong>
                                {prediction.confidence_level === ConfidenceLevel.HIGH && (
                                    <span> Predicție foarte fiabilă bazată pe date istorice solide.</span>
                                )}
                                {prediction.confidence_level === ConfidenceLevel.MEDIUM && (
                                    <span> Predicție cu fiabilitate moderată pentru viitorul apropiat.</span>
                                )}
                                {prediction.confidence_level === ConfidenceLevel.LOW && (
                                    <span> Predicție cu incertitudine sporită datorită distanței temporale.</span>
                                )}
                                {prediction.confidence_level === ConfidenceLevel.VERY_LOW && (
                                    <span> Predicție exploratorie cu incertitudine ridicată.</span>
                                )}
                            </div>
                        </div>
                    </div>
                ...
                {!prediction && (
                    <div className="text-center text-sm text-gray-500 bg-gray-50 rounded-lg p-4">
                        <p>💡 <strong>Sugestie:</strong> Începe cu României și o cultură familiară ca Wheat sau Maize pentru rezultate mai fiabile.</p>
                        <p className="mt-1">📅 Perioada suportată: 2025-2050</p>
                    </div>
                )}
            </CardContent>
        </Card>
