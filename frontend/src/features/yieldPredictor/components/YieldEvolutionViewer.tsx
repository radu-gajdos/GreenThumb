    ...
    <div className="space-y-6 p-6">
      ...
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">
          Evoluția Globală a Rendamentului Agricol
        </h1>
        <p className="text-gray-600 max-w-2xl mx-auto">
          Analizează evoluția randamentului culturilor agricole pe țări în perioada 2000-2024 
          folosind predicții AI avansate cu nivele de încredere și metode de predicție.
        </p>
      </div>
            ...
            >
              {loading ? (
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>Generează Evoluția AI</span>
                </div>
              )}
            </Button>
          </div>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                ...
                Distribuția Nivelurilor de Încredere AI
              </CardTitle>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <Card className="border-green-200 bg-green-50">
                  <CardContent className="p-4">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-medium text-green-800">Înaltă</span>
                    </div>
                    <div className="text-2xl font-bold text-green-900">
                      {evolutionData.highConfidencePoints}
                    </div>
                    <div className="text-xs text-green-700">predicții</div>
                  </CardContent>
                </Card>
                ...
                <Card className="border-yellow-200 bg-yellow-50">
                  <CardContent className="p-4">
                    ...
                    <div className="text-xs text-yellow-700">predicții</div>
                  </CardContent>
                </Card>
                ...
                <Card className="border-orange-200 bg-orange-50">
                  <CardContent className="p-4">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-medium text-orange-800">Scăzută</span>
                    </div>
                    <div className="text-2xl font-bold text-orange-900">
                      {evolutionData.lowConfidencePoints}
                    </div>
                    <div className="text-xs text-orange-700">predicții</div>
                  </CardContent>
                </Card>
                ...
                <Card className="border-red-200 bg-red-50">
                  <CardContent className="p-4">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-medium text-red-800">F. Scăzută</span>
                    </div>
                    <div className="text-2xl font-bold text-red-900">
                      {evolutionData.veryLowConfidencePoints}
                    </div>
                    <div className="text-xs text-red-700">predicții</div>
                  </CardContent>
                </Card>
              </div>
            </CardContent>
            ...
            <CardHeader>
              <CardTitle className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span>Evoluția Randamentului (2000-2024)</span>
                </div>
                <div className="flex items-center gap-2">
          ...
          <Card className="border-blue-200 bg-blue-50">
            ...
            <CardContent className="text-blue-800">
              ...
              <p className="mt-3 text-xs text-blue-700">
                Predicțiile sunt generate folosind un model AI antrenat pe date globale FAOSTAT. 
                Nivelul de încredere reflectă certitudinea modelului bazată pe disponibilitatea datelor istorice 
                și distanța temporală față de prezent.
              </p>
            </CardContent>
          </Card>
        </div>
